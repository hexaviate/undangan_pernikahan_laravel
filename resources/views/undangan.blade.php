                ...
                <div class="d-flex position-absolute w-100 h-100">
                    <div class="position-relative overflow-hidden vw-100">
                        <div class="position-absolute h-100 w-100 slide-desktop" style="opacity: 0;">
                            <img src="{{ asset('assets/images/WhatsApp Image 2025-09-02 at 10.54.08.jpeg') }}"
            ...
            <main data-bs-spy="scroll" data-bs-target="#navbar-menu" data-bs-root-margin="25% 0% 0% 0%"
                ...
                <section id="home" class="bg-light-dark position-relative overflow-hidden p-0 m-0">
                    ...
                    <div class="position-relative text-center bg-overlay-auto" style="background-color: unset;">
                        ...
                        <h2 class="font-esthetic my-4" style="font-size: 2.25rem;">{{ $undangan->isiUndangan->MempelaiL->nama }} &amp; {{ $undangan->isiUndangan->MempelaiP->nama }}</h2>
                        <p class="my-2" style="font-size: 1.25rem;">{{ $undangan->isiUndangan->waktuDanTempat->tanggal_resepsi->translatedFormat('l, d F Y') }}</p>
                ...
                <!-- Love Story -->
                @if (isset($undangan->isiUndangan->cerita))
                <section class="bg-light-dark pt-2 pb-4">
                    <div class="container">
                        <div class="bg-theme-auto rounded-5 shadow p-3">
                            ...
                            <div id="video-love-stroy" class="position-relative rounded-4 mb-1 pb-0"
                                data-src="{{ asset('video/' . $undangan->isiUndangan->cerita->video) }}"
                                ...
                                <div class="overflow-y-scroll overflow-x-hidden p-2 with-scrollbar"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col mt-1 mb-3 ps-0">
                                            ...
                                            <p class="small mb-0">
                                                {{ $undangan->isiUndangan->cerita->cerita1 }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col mt-1 mb-3 ps-0">
                                            ...
                                            <p class="small mb-0">
                                                {{ $undangan->isiUndangan->cerita->cerita2 }}
                                            </p>
                                        </div>
                                    </div>
                                    <div class="row">
                                        ...
                                        <div class="col mt-1 mb-3 ps-0">
                                            ...
                                            <p class="small mb-0">
                                                {{ $undangan->isiUndangan->cerita->cerita3 }}
                                            </p>
                                        </div>
                                    </div>
                                </div>
        ...
        <div class="container text-center">
            ...
            <div class="border rounded-pill shadow py-2 px-4 mt-2 mb-4">
                <div class="row justify-content-center">
                    <div class="col-3 p-1">
                        <p class="d-inline m-0 p-0" style="font-size: 1.25rem;" id="akad-day">0</p>
                        <small class="ms-1 me-0 my-0 p-0 d-inline">Hari</small>
                    </div>
                    <div class="col-3 p-1">
                        <p class="d-inline m-0 p-0" style="font-size: 1.25rem;" id="akad-hour">0</p>
                        <small class="ms-1 me-0 my-0 p-0 d-inline">Jam</small>
                    </div>
                    <div class="col-3 p-1">
                        <p class="d-inline m-0 p-0" style="font-size: 1.25rem;" id="akad-minute">0</p>
                        <small class="ms-1 me-0 my-0 p-0 d-inline">Menit</small>
                    </div>
                    <div class="col-3 p-1">
                        <p class="d-inline m-0 p-0" style="font-size: 1.25rem;" id="akad-second">0</p>
                        <small class="ms-1 me-0 my-0 p-0 d-inline">Detik</small>
                    </div>
                </div>
            </div>

            {{-- script nya untuk couldlon --}}

            @if ($undangan->isiUndangan->waktuDanTempat->tanggal_akad)
                <script>
                    // ambil tanggal dari database (formatnya udah string)
                    var targetDate = new Date("{{ \Carbon\Carbon::parse($undangan->isiUndangan->waktuDanTempat->tanggal_akad)->format('Y-m-d\TH:i:s') }}").getTime();
                    ...
                    var countdown = setInterval(function() {
                        ...
                        document.getElementById("akad-day").innerHTML = days;
                        document.getElementById("akad-hour").innerHTML = hours;
                        document.getElementById("akad-minute").innerHTML = minutes;
                        document.getElementById("akad-second").innerHTML = seconds;

                        if (distance < 0) {
                            clearInterval(countdown);
                            document.getElementById("akad-day").innerHTML = 0;
                            document.getElementById("akad-hour").innerHTML = 0;
                            document.getElementById("akad-minute").innerHTML = 0;
                            document.getElementById("akad-second").innerHTML = 0;
                        }
                    }, 1000);
                </script> @endif

            <p class="py-2
        m-0" style="font-size: 0.95rem;">Dengan memohon rahmat dan ridho Allah
    Subhanahu Wa Ta'ala, insyaAllah kami akan menyelenggarakan acara:</p>

    <!-- Love animation -->
    <div class="position-relative">
        <div class="position-absolute" style="top: 0%; right: 5%;">
            <svg xmlns="http://www.w3.org/2000/svg" width="40" height="40" fill="currentColor" class="opacity-50"
                data-time="3000" data-class="animate-love" viewBox="0 0 16 16">
                <path
                    d="m8 2.748-.717-.737C5.6.281 2.514.878 1.4 3.053c-.523 1.023-.641 2.5.314 4.385.92 1.815 2.834 3.989 6.286 6.357 3.452-2.368 5.365-4.542 6.286-6.357.955-1.886.838-3.362.314-4.385C13.486.878 10.4.28 8.717 2.01zM8 15C-7.333 4.868 3.279-3.04 7.824 1.143q.09.083.176.171a3 3 0 0 1 .176-.17C12.72-3.042 23.333 4.867 8 15" />
            </svg>
        </div>
    ...
    <section class="bg-white-black pb-5 pt-3" id="gallery">
        <div class="container">
            <div class="border rounded-5 shadow p-3">
                ...
                <div id="carousel-image-two" data-aos="fade-up" data-aos-duration="1500" class="carousel slide mt-4"
                    data-bs-ride="carousel">
                    <div class="carousel-indicators">
        ...
        <div class="container text-center">
            ...
            <div class="bg-theme-auto rounded-4 shadow p-3 mx-4 mt-4 text-start" data-aos="fade-up"
                ...
                <div class="d-flex justify-content-between align-items-center mt-2">
                    <p class="m-0 p-0" style="font-size: 0.95rem;"><i class="fa-regular fa-user fa-sm me-1"></i>Riski
                        Siapa?</p>
                    <button class="btn btn-outline-auto btn-sm shadow-sm rounded-4 py-0" style="font-size: 0.75rem;"
                        data-bs-toggle="collapse" data-bs-target="#collapseTf"><i
            ...
            <div class="bg-theme-auto rounded-4 shadow p-3 mx-4 mt-4 text-start" data-aos="fade-up"
                ...
                <div class="d-flex justify-content-between align-items-center mt-2">
                    <p class="m-0 p-0" style="font-size: 0.95rem;"><i class="fa-regular fa-user fa-sm me-1"></i>Wahyu
                        Siapa?</p>
                    <button class="btn btn-outline-auto btn-sm shadow-sm rounded-4 py-0" style="font-size: 0.75rem;"
                        data-bs-toggle="collapse" data-bs-target="#collapseQris"><i
                            class="fa-solid fa-circle-info fa-sm me-1"></i>Info</button>
                </div>
                ...
                <div class="collapse" id="collapseQris">
                    ...
                    <div class="d-flex justify-content-center align-items-center">
                        <img src="{{ asset('assets/images/placeholder.webp') }}"
                            data-src="{{ asset('assets/images/donate.png') }}" fetchpriority="high" decoding="async"
                            alt="donate" class="img-fluid rounded-3 mx-auto bg-white">
                    </div>
                </div>
            </div>
            ...
            <div class="bg-theme-auto rounded-4 shadow p-3 mx-4 mt-4 text-start" data-aos="fade-up"
                ...
                <div class="d-flex justify-content-between align-items-center mt-2">
                    <p class="m-0 p-0" style="font-size: 0.95rem;"><i class="fa-regular fa-user fa-sm me-1"></i>Wahyu
                        Siapa?</p>
                    <button class="btn btn-outline-auto btn-sm shadow-sm rounded-4 py-0" style="font-size: 0.75rem;"
                        data-bs-toggle="collapse" data-bs-target="#collapseGift"><i
                            class="fa-solid fa-circle-info fa-sm me-1"></i>Info</button>
                </div>
                ...
                <div class="collapse" id="collapseGift">
                    ...
                    <div class="d-flex justify-content-between align-items-center mb-2">
                        ...
                        <button class="btn btn-outline-auto btn-sm shadow-sm rounded-4 py-0"
                            style="font-size: 0.75rem;" data-copy="0812345678" onclick="undangan.util.copy(this)"><i
        ...
        <div class="container">
            <div class="border rounded-5 shadow p-3 mb-2">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" class="form-control shadow-sm rounded-4" id="form-name" minlength="2"
                        maxlength="50" placeholder="Isikan Nama Anda" autocomplete="name"
                ...
                <div class="d-block mb-3" id="comment-form-default">
                    ...
                    <label for="form-comment" class="form-label my-1"><i class="fa-solid fa-comment me-2"></i>Ucapan
                        &amp; Doa</label>
                    <div class="position-relative">
                        <button
                            class="btn btn-secondary btn-sm rounded-4 shadow-sm me-1 my-1 position-absolute bottom-0 end-0"
                            onclick="undangan.comment.gif.open(undangan.comment.gif.default)" aria-label="button gif"
                            data-offline-disabled="false"><i class="fa-solid fa-photo-film"></i></button>
                ...
                <div class="d-grid">
                    <button class="btn btn-primary btn-sm rounded-4 shadow m-1" onclick="undangan.comment.send(this)"
                        data-offline-disabled="false">
    ...
    <div class="loading-page bg-white-black" id="welcome" style="opacity: 1;">
        <div class="d-flex justify-content-center align-items-center vh-100 overflow-y-auto">
            <div class="d-flex flex-column text-center">
                ...
                <img src="{{ asset('assets/images/WhatsApp Image 2025-09-02 at 10.54.08.jpeg') }}"
                    data-src="{{ asset('assets/images/WhatsApp Image 2025-09-02 at 10.54.08.jpeg') }}"
                    fetchpriority="high" decoding="async" alt="background"
                ...
                <h2 class="font-esthetic mb-4" style="font-size: 2.25rem;">
                    {{ $undangan->isiUndangan->mempelaiL->nama }} &amp; {{ $undangan->isiUndangan->MempelaiP->nama }}
                </h2>
                ...
                <div class="modal-body p-0">
                    <div class="d-flex position-absolute top-0 end-0">
                        <a class="btn d-flex justify-content-center align-items-center bg-overlay-auto p-2 m-1 rounded-circle border shadow-sm z-1"
                            ...
                            href="{{ asset('assets/images/WhatsApp Image 2025-09-02 at 10.54.08.jpeg') }}"
